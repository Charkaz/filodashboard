...
part of 'board_remote_data_source.dart';
...
class _BoardRemoteDataSource implements BoardRemoteDataSource {
  _BoardRemoteDataSource(
    this._dio, {
    this.baseUrl,
    this.errorLogger,
  });
  ...
  Future<List<BoardModel>> getBoards() async {
    ...
    final _options = _setStreamType<List<BoardModel>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<CardModel> createCard(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(params);
    final _options = _setStreamType<CardModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
